 ...
 * 
 */
package com.d2h.service.domain.android.copy;
...
public class MProduct {
		...
		private String totalPriceInCart;
		...
		/**
		 * @param productSubCatagory the productSubCatagory to set
		 */
		...
		/**
		 * @return the productVender
		 */
		public String getProductVender() {
			return productVender;
		}
		/**
		 * @param productVender the productVender to set
		 */
	 ...
	 /*productId, productName, productCategory, productSubCategory, venderId, venderName, 
	 productDesc, availableQty, price, maxSellPrice, ourPrice, productBuyDate, 
	 discountPercentage, productUrl, categoryId, subcategoryId*/
	...
	*//**
	 * @param maxSellPrice the maxSellPrice to set
	 *//*
	...
	*//**
	 * @return the productBuyDate
	 *//*
	public String getProductBuyDate() {
		return productBuyDate;
	}
	*//**
	 * @param productBuyDate the productBuyDate to set
	 *//*
