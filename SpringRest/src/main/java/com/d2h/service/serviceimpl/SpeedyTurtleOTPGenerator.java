 ...
 *
 */
public class SpeedyTurtleOTPGenerator {

	private SpeedyTurtleOTPGenerator() {
	}
	...
	public static String  getOtp(String pass) throws InvalidKeyException, NoSuchAlgorithmException {
//		String pass = "12345678901234567890";
		byte[] code = pass.getBytes();
//		String otp = new SpeedyTurtleOTPGenerator().generateOTP(code, 0, 4, false, 0);
/*		for (int i = 0; i < 1; i++) {
			try {
				System.out.println();
			} catch (Exception e) {
...
*/	
		return new SpeedyTurtleOTPGenerator().generateOTP(code, 0, 4, false, 0);
	}
